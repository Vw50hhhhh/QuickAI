...
export const AiToolsData = [
  {
    title: "AI 智能写作助手",
    description: "借助先进的 AI 写作技术，轻松生成高质量、有吸引力的主题文章。",
    Icon: SquarePen,
  ...
  {
    title: "博客标题生成器",
    description: "用 AI 灵感为你的博客找到最吸睛、最契合主题的完美标题。",
    Icon: Hash,
  ...
  },
  {
    title: "AI 图像生成",
    description:
      "用我们的 AI 图像生成工具，轻松创作令人惊艳的视觉作品，体验 AI 的无限创意。",
    Icon: Image,
  ...
  {
    title: "背景智能去除",
    description: "借助 AI 驱动的工具，轻松去除图片背景，让主体更加突出。",
    Icon: Eraser,
  ...
  {
    title: "AI 对象移除",
    description: "无痕去除图片中不需要的元素，让每一张图都更干净、自然。",
    Icon: Scissors,
  ...
  {
    title: "AI 简历优化助手",
    description: "让 AI 为你的简历提出专业建议，提升获得理想工作的成功率。",
    Icon: FileText,
